...
from database import ATHLETE_DB, _FOLLOWS, _save_db
...
async def get_feed(athlete_id: str = "", tab: str = "for_you", page: int = 1):
    posts = [
        {"id": "p1", "author": "Rishi Arora", "handle": "@RishiArora", "initials": "RA", "avatarColor": "#06b6d4", "sport": "Athletics", "content": "Just hit a new PB in the 400m! Hard work finally paying off", "likes": 142, "comments": 18, "timeAgo": "2h", "isFollowing": False},
        {"id": "p2", "author": "Aditi Dixit", "handle": "@AditiDixit", "initials": "AD", "avatarColor": "#ec4899", "sport": "Yoga", "content": "Morning session complete. Pranayama + 45 min flow.", "likes": 287, "comments": 34, "timeAgo": "4h", "isFollowing": True},
        {"id": "p3", "author": "Moh. Usman", "handle": "@MohUsman", "initials": "MU", "avatarColor": "#f97316", "sport": "Kabaddi", "content": "District championships next week! Training twice a day.", "likes": 98, "comments": 22, "timeAgo": "6h", "isFollowing": False},
...
async def get_classes(athlete_id: str = ""):
    all_classes = [
        {"id": "cl1", "title": "3 V 3 Bounce Ball", "sport": "Basketball", "date": "19 May 2024", "period": "3rd Period", "teacherName": "Mr. Raj Kumar", "teacherRating": 5, "teacherFeedback": "Puts forth personal best effort.", "studentRating": 0, "thumbnail": "basketball", "color": "#f97316", "athlete_ids": []},
        {"id": "cl2", "title": "Kabaddi Fundamentals", "sport": "Kabaddi", "date": "15 May 2024", "period": "2nd Period", "teacherName": "Ms. Priya Singh", "teacherRating": 4, "teacherFeedback": "Shows excellent teamwork.", "studentRating": 4, "thumbnail": "kabaddi", "color": "#ef4444", "athlete_ids": []},
        {"id": "cl3", "title": "100m Sprint Drills", "sport": "Athletics", "date": "12 May 2024", "period": "1st Period", "teacherName": "Mr. Arvind Mehta", "teacherRating": 5, "teacherFeedback": "Consistent improvement in stride length.", "studentRating": 5, "thumbnail": "athletics", "color": "#22c55e", "athlete_ids": []},
    ]
